                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                        ...
                        children: [
                          ...
                          _buildTopicTile(
                            ...
                            onTap: () => _showContentDialog(
                              context, 
                              'Payments', 
                              'We accept Cash on Delivery, JazzCash, and EasyPaisa. Credit/Debit card payments are coming soon. All transactions are secured and encrypted.'
                            ),
                          ),
                          _buildTopicTile(
                            context,
                            ...
                            onTap: () => _showContentDialog(
                              context, 
                              'Refunds', 
                              'Refunds are processed within 3-5 business days for cancelled orders. For quality issues, please contact our support team with your order ID and photos.'
                            ),
                          ),
                          _buildTopicTile(
                            context,
                      ...
                      _buildFaqItem(
                        ...
                        answer: 'Once your order is confirmed, go to the "Orders" tab and select your active order. You can view the live status and track the rider on the map.',
                      ),
                      _buildFaqItem(
                        context,
                        question: 'Can I cancel my order?',
                        answer: 'Orders can only be cancelled within 2 minutes of placement. After the restaurant starts preparing your food, cancellation is not possible.',
                      ),
                      _buildFaqItem(
                        context,
                        question: 'What are pizza points?',
                        answer: 'Pizza Points are rewards you earn on every order. 100 points equal Rs. 10. You can redeem them for discounts on your future pizza cravings!',
                      ),
                      _buildFaqItem(
                        context,
                        question: 'Delivery areas in Vehari',
                        answer: 'We currently deliver within a 10km radius of Vehari City center, including 9-11/WB, People\'s Colony, and surrounding areas.',
                      ),
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: Text(content, style: const TextStyle(color: AppColors.subtle, fontSize: 14)),
        ),
        actions: [
          TextButton(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildNavItem(context, Icons.stars, 'Rewards', selected: false, onTap: () {
            // Placeholder: Most rewards logic is on the profile screen
