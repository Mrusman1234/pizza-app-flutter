...
class _AdminLoginScreenState extends State<AdminLoginScreen> {
  ...
  Future<void> _handleAdminLogin() async {
    if (_formKey.currentState!.validate()) {
      // Validate Security Token if provided in .env
      final requiredToken = dotenv.env['ADMIN_LOGIN_TOKEN'];
      if (requiredToken != null && requiredToken.isNotEmpty) {
        if (_adminTokenController.text.trim() != requiredToken) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
              content: Text("Invalid Security Token"),
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Security Token Field for extra admin security
                  CustomTextField(
